    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
           ...
           // Cuentos cuentos= new Cuentos();
            //fragmentManager.beginTransaction().replace(R.id.contenedor,cuentos).commit();

        } else if (id == R.id.nav_gallery) {

            //Intent nuevo = new Intent(this,Video.class);
           // startActivity(nuevo);

        } else if (id == R.id.nav_slideshow) {
            //Intent nuevo = new Intent(this,Video2.class);
            //startActivity(nuevo);
